    ...
    public class DynamicFolderBundle : Bundle {
        ...
        public string SearchPattern {
            ...
            set {
                ...
                PatternType type = PatternHelper.GetPatternType(value);
                Exception error = PatternHelper.ValidatePattern(type, value, "value");
                if (error != null) {
                    throw error;
                }
        ...
        public override IEnumerable<BundleFile> EnumerateFiles(BundleContext context) {
            ...
            string directoryVirtualPath = VirtualPathUtility.GetDirectory(context.BundleVirtualPath);
